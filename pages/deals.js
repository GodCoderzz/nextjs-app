...
const Sales = ({products}) => {
  const [Deal, setDeal] = useState(products)

  return <>


    <section className="text-gray-600 body-font">
      <div className="container px-5 py-16 mb-6 mx-auto">
        <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
          <h1 className="flex-grow sm:pr-16 text-3xl font-medium title-font text-gray-900">Grab these top deals <br /> of the day with maximum discount!</h1>
          <button className="flex justify-center items-center text-white bg-blue-500 border-0 py-2 px-5 focus:outline-none hover:bg-blue-600 rounded text-lg mt-10 sm:mt-0"><span className='pr-2'>Get More</span> <FaAmazon className='text-xl' /></button>
        </div>
      </div>
    </section>
   ...
   {Deal && Deal.map((item) => { return <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-12 mx-auto">
        <div className="flex flex-wrap  mb-4 mx-auto">
          <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
            <h1 className="sm:text-xl text-2xl font-medium title-font mb-2 text-gray-900">Deal #{item.oid}</h1>
